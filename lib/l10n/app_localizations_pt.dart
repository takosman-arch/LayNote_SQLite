...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get noteActionClassifyLabel => 'Pasta';

  @override
  String get noteActionDeleteLabel => 'Eliminar';

  @override
  String get noteActionPinToNotificationLabel => 'Afixar na\nNotificação';
  ...
  String get welcomeNoteContent =>
      '[{\"type\": \"text\", \"text\": \"Escreva suas notas, organize-as e encontre-as facilmente sempre que precisar. \\n\\n\\nConfira alguns recursos;\\n\\nReunião – 25 de agosto \\n• Novo plano de projeto \\n• Atribuir uma tarefa \\n• Prazo: 10 de setembro \\n\\n✈️ Preparativos de viagem \", \"spans\": []}, {\"type\": \"checklist\", \"items\": [{\"text\": \"Passagem aérea \", \"checked\": false, \"spans\": []}, {\"text\": \"Reserva de hotel \", \"checked\": false, \"spans\": []}, {\"text\": \"Passaporte \", \"checked\": true, \"spans\": []}]}, {\"type\": \"text\", \"text\": \"\", \"spans\": []}, {\"type\": \"table\", \"rows\": [[{\"text\": \"Material \", \"spans\": [{\"start\": 0, \"end\": 8, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}, {\"text\": \"Estoque\", \"spans\": [{\"start\": 0, \"end\": 7, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}, {\"text\": \"Status \", \"spans\": [{\"start\": 0, \"end\": 6, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}], [{\"text\": \"Cabo \", \"spans\": []}, {\"text\": \"25\", \"spans\": []}, {\"text\": \"Suficiente \", \"spans\": []}]]}, {\"type\": \"text\", \"text\": \"\", \"spans\": []}, {\"type\": \"calc_table\", \"rows\": [{\"label\": \"Despesas \", \"spans\": [], \"value\": \"1.500\", \"valueSpansHolder\": {\"spans\": []}}, {\"label\": \"Custo\", \"spans\": [], \"value\": \"800\", \"valueSpansHolder\": {\"spans\": []}}]}, {\"type\": \"text\", \"text\": \"\\nDigite uma expressão e pressione igual para calculá-la automaticamente. \\n\\n15+6 = 21    (10+2)*3 = 36    3^2 = 9\\n500+18 % = 590      \$100*3 = \$300\\n\\nOvos \$3\\nPão \$2\\nLeite \$4\\nTotal = \$9\\n \", \"spans\": [{\"start\": 82, \"end\": 84, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 99, \"end\": 101, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 111, \"end\": 112, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 124, \"end\": 127, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 142, \"end\": 146, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}]}]';
  ...
  @override
  String get pinNoteMenuItemLabel => 'Fixar';

  @override
  String get unpinNoteMenuItemLabel => 'Desafixar';
  ...
  @override
  String get imageViewerFileNotFoundMessage => 'Este arquivo não existe mais';

  @override
  String get findMenuItemLabel => 'Localizar';

  @override
  String get findSearchHint => 'Pesquisar';

  @override
  String get findReplaceHint => 'Substituir por';

  @override
  String get findReplaceButton => 'Substituir';

  @override
  String get findReplaceAllButton => 'Substituir tudo';

  @override
  String get findPreviousTooltip => 'Correspondência anterior';

  @override
  String get findNextTooltip => 'Próxima correspondência';

  @override
  String get findShowReplaceTooltip => 'Mostrar campo de substituição';

  @override
  String get findHideReplaceTooltip => 'Ocultar campo de substituição';

  @override
  String get findCloseTooltip => 'Fechar pesquisa';

  @override
  String get proUpgradeHeadline => 'Mais com o Layout Pro';

  @override
  String get proFeatureFolderLockTitle => 'Bloqueio de pastas';

  @override
  String get proFeatureFolderLockSubtitle =>
      'Proteja as pastas que quiser com uma palavra-passe.';

  @override
  String get proFeatureSubfoldersTitle => 'Subpastas';

  @override
  String get proFeatureSubfoldersSubtitle =>
      'Adicione um nível de subpastas às suas pastas.';

  @override
  String get proFeatureAccentColorsTitle => 'Mais cores de destaque';

  @override
  String get proFeatureAccentColorsSubtitle =>
      'Escolha a cor que quiser numa paleta alargada.';

  @override
  String get proFeatureRecurringAlarmTitle => 'Alarmes repetidos';

  @override
  String get proFeatureRecurringAlarmSubtitle =>
      'Repita os seus lembretes diariamente, semanalmente e mais.';

  @override
  String get proFeaturePinNotesTitle => 'Fixação ilimitada de notas';

  @override
  String get proFeaturePinNotesSubtitle =>
      'Fixe tantas notas quantas quiser no painel de notificações.';

  @override
  String get proFeatureExportTitle => 'Exportação em PDF / JPG';

  @override
  String get proFeatureExportSubtitle =>
      'Exporte as suas notas como PDF ou imagem.';

  @override
  String get proFeatureDocumentScanTitle => 'Digitalização de documentos';

  @override
  String get proFeatureDocumentScanSubtitle =>
      'Digitalize documentos em papel com a câmara e adicione-os à sua nota.';

  @override
  String get proFeatureSpeechToTextTitle => 'Voz para texto';

  @override
  String get proFeatureSpeechToTextSubtitle =>
      'Dite as suas notas e elas são convertidas automaticamente em texto.';

  @override
  String get proFeatureUnlimitedAttachmentsTitle =>
      'Imagens e ficheiros ilimitados';

  @override
  String get proFeatureUnlimitedAttachmentsSubtitle =>
      'Anexe às suas notas tantas imagens e ficheiros quantos quiser.';
  ...
  String get proSubscriptionNote =>
      'O Pro mensal renova-se automaticamente. Pode cancelá-lo a qualquer momento no Google Play.';

  @override
  String get proActiveTitle => 'Pro ativo';

  @override
  String get proActiveSubtitle => 'Desbloqueou todas as funcionalidades Pro.';

  @override
  String get proProductsLoadErrorMessage =>
      'Não foi possível carregar os preços. Verifique a sua ligação e tente novamente.';

  @override
  String get proRetryButton => 'Tentar novamente';

  @override
  String get proPurchaseSuccessMessage => 'Bem-vindo ao Pro!';

  @override
  String get proRestoreSuccessMessage =>
      'A sua compra foi restaurada. O Pro está ativo.';

  @override
  String get proRestoreNothingFoundMessage =>
      'Não foi encontrada nenhuma compra Pro ativa para esta conta.';

  @override
  String get proPurchasePendingMessage =>
      'O seu pagamento está pendente. O Pro será desbloqueado automaticamente assim que for aprovado.';

  @override
  String get proPurchaseCanceledMessage => 'Compra cancelada.';

  @override
  String get proPurchaseErrorMessage => 'Ocorreu um problema. Tente novamente.';
