...
class AppLocalizationsNo extends AppLocalizations {
  ...
  @override
  String get reorderFoldersCriterionCountLabel => 'Antall notater';

  @override
  String get reorderFoldersAscendingLabel => 'Stigende';

  @override
  String get reorderFoldersDescendingLabel => 'Synkende';

  @override
  String get reorderFoldersManualSectionTitle => 'Manuell rekkefølge';

  @override
  String get reorderFoldersManualSectionDescription =>
      'Trykk på en mappe for å velge den, og bruk deretter pilene opp/ned for å flytte den.';

  @override
  String get reorderFoldersMoveUpTooltip => 'Flytt opp';

  @override
  String get reorderFoldersMoveDownTooltip => 'Flytt ned';

  @override
  String get reorderFoldersCloseTooltip => 'Lukk';
  ...
  String get trashEmptySubtitle =>
      'Notater flyttet hit slettes permanent etter 30 dager.';

  @override
  String get favoritesEmptySubtitle =>
      'Notater du merker som favoritt, vises her.';

  @override
  String get lockedEmptyTitle => 'Ingen låste notater';

  @override
  String get lockedEmptySubtitle => 'Notater du låser, vises her.';

  @override
  String get remindersEmptyTitle => 'Ingen påminnelser';

  @override
  String get remindersEmptySubtitle => 'Notater med påminnelser vises her.';

  @override
  String get folderEmptyTitle => 'Ingen notater i denne mappen';

  @override
  String get folderEmptySubtitle => 'Flytt notater hit for å organisere dem.';

  @override
  String get archiveEmptyTitle => 'Ingen arkiverte notater';

  @override
  String get archiveEmptySubtitle => 'Notater du arkiverer, vises her.';
  ...
  @override
  String get settingsFlagAsCoverColorTitle => 'Flaggfarge som omslag';

  @override
  String get settingsFlagAsCoverColorSubtitle =>
      'Bruker flaggfargen som omslagsfarge.';

  @override
  String get settingsDrawerSectionsTitle => 'Sidemeny';

  @override
  String get settingsDrawerSectionsAllVisibleSubtitle =>
      'Alle seksjoner synlige';

  @override
  String get settingsDrawerSectionsSomeHiddenSubtitle =>
      'Noen seksjoner skjult';

  @override
  String get settingsDrawerSectionsDialogTitle => 'Sidemenyens seksjoner';
  ...
  String get welcomeNoteContent =>
      '[{\"type\": \"text\", \"text\": \"Skriv notatene dine, organiser dem, og finn dem enkelt når du trenger dem. \\n\\n\\nUtforsk noen funksjoner;\\n\\nMøte – 25. august \\n• Ny prosjektplan \\n• Tildel en oppgave \\n• Frist: 10. september \\n\\n✈️ Reiseforberedelser \", \"spans\": []}, {\"type\": \"checklist\", \"items\": [{\"text\": \"Flybillett \", \"checked\": false, \"spans\": []}, {\"text\": \"Hotellreservasjon \", \"checked\": false, \"spans\": []}, {\"text\": \"Pass \", \"checked\": true, \"spans\": []}]}, {\"type\": \"text\", \"text\": \"\", \"spans\": []}, {\"type\": \"table\", \"rows\": [[{\"text\": \"Materiale \", \"spans\": [{\"start\": 0, \"end\": 9, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}, {\"text\": \"Lager\", \"spans\": [{\"start\": 0, \"end\": 5, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}, {\"text\": \"Status \", \"spans\": [{\"start\": 0, \"end\": 6, \"bold\": true, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": null, \"fontFamily\": null, \"link\": null}]}], [{\"text\": \"Kabel \", \"spans\": []}, {\"text\": \"25\", \"spans\": []}, {\"text\": \"Tilstrekkelig \", \"spans\": []}]]}, {\"type\": \"text\", \"text\": \"\", \"spans\": []}, {\"type\": \"calc_table\", \"rows\": [{\"label\": \"Utgifter \", \"spans\": [], \"value\": \"1.500\", \"valueSpansHolder\": {\"spans\": []}}, {\"label\": \"Kostnad\", \"spans\": [], \"value\": \"800\", \"valueSpansHolder\": {\"spans\": []}}]}, {\"type\": \"text\", \"text\": \"\\nSkriv inn et uttrykk og trykk på likhetstegnet for å beregne det automatisk. \\n\\n15+6 = 21    (10+2)*3 = 36    3^2 = 9\\n500+18 % = 590      \$100*3 = \$300\\n\\nEgg \$3\\nBrød \$2\\nMelk \$4\\nTotalt = \$9\\n \", \"spans\": [{\"start\": 87, \"end\": 89, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 104, \"end\": 106, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 116, \"end\": 117, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 129, \"end\": 132, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}, {\"start\": 147, \"end\": 151, \"bold\": false, \"italic\": false, \"underline\": false, \"strikethrough\": false, \"highlight\": false, \"fontSize\": null, \"color\": 4294951175, \"fontFamily\": null, \"link\": null}]}]';
  ...
  @override
  String get tagsMenuItemLabel => 'Emneknagg';

  @override
  String get flagColorMenuItemLabel => 'Flagg';
  ...
  @override
  String get flagColorNameOrange => 'Personlig';

  @override
  String get flagColorNameYellow => 'Ideer';

  @override
  String get flagColorNameGreen => 'Påbegynt';

  @override
  String get flagColorNameBlue => 'Fullført';
  ...
  @override
  String get proFeatureFolderLockTitle => 'Mappelås';

  @override
  String get proFeatureFolderLockSubtitle =>
      'Beskytt hvilke mapper du vil med passord.';
  ...
  String get proFeatureSubfoldersSubtitle =>
      'Legg til ett nivå med undermapper i mappene dine.';

  @override
  String get proFeatureAccentColorsTitle => 'Flere aksentfarger';

  @override
  String get proFeatureAccentColorsSubtitle =>
      'Velg fra en utvidet fargepalett.';

  @override
  String get proFeatureRecurringAlarmTitle => 'Gjentakende alarmer';

  @override
  String get proFeatureRecurringAlarmSubtitle =>
      'Gjenta påminnelsene dine daglig, ukentlig og mer.';

  @override
  String get proFeaturePinNotesTitle => 'Ubegrenset festing av notater';

  @override
  String get proFeaturePinNotesSubtitle =>
      'Fest så mange notater du vil i varselpanelet.';
  ...
  String get proFeatureExportSubtitle =>
      'Eksporter notatene dine som PDF eller bilde.';
  ...
  String get proFeatureDocumentScanSubtitle =>
      'Skann papirdokumenter med kameraet og legg dem til i notatet.';
  ...
  String get proFeatureSpeechToTextSubtitle =>
      'Snakk inn notater, så gjøres de automatisk om til tekst.';

  @override
  String get proFeatureUnlimitedAttachmentsTitle =>
      'Ubegrensede bilder og filer';

  @override
  String get proFeatureUnlimitedAttachmentsSubtitle =>
      'Legg til så mange bilder og filer i notatene dine du vil.';
  ...
  @override
  String get proPurchaseButton => 'Fortsett';

  @override
  String get proRestorePurchasesButton => 'Gjenopprett kjøp';

  @override
  String get proSubscriptionNote =>
      'Månedlig Pro fornyes automatisk. Du kan si opp når som helst i Google Play.';

  @override
  String get proActiveTitle => 'Pro er aktiv';

  @override
  String get proActiveSubtitle => 'Du har låst opp alle Pro-funksjoner.';

  @override
  String get proProductsLoadErrorMessage =>
      'Kunne ikke laste priser. Sjekk tilkoblingen og prøv igjen.';

  @override
  String get proRetryButton => 'Prøv igjen';
  ...
  String get proRestoreSuccessMessage =>
      'Kjøpet ditt ble gjenopprettet. Pro er aktivt.';

  @override
  String get proRestoreNothingFoundMessage =>
      'Fant ingen aktivt Pro-kjøp for denne kontoen.';

  @override
  String get proPurchasePendingMessage =>
      'Betalingen din venter på godkjenning. Pro låses automatisk opp når den er godkjent.';

  @override
  String get proPurchaseCanceledMessage => 'Kjøp avbrutt.';

  @override
  String get proPurchaseErrorMessage => 'Noe gikk galt. Prøv igjen.';
