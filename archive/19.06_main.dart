...
class _NoteListScreenState extends State<NoteListScreen> {
  ...
  int _getCountForCategory(String category) {
    return _notes.where((note) {
      ...
      if (category == 'Tümü' || category == 'Notlar') {
        ...
        return !isArchived && note['category'] == category;
      }
    }).length;
  }
  ...
  void _showNoteActions(BuildContext ctx, int noteIndex, bool isTrash) {
    ...
    final actions = [
      ...
      {'icon': Icons.lock_outline, 'label': 'Kilitle', 'color': Colors.blueGrey, 'key': 'lock'},
      {
    ...
    if (isTrash) {
      ...
      filteredNotes = _notes.where((note) {
        ...
        if (_activeCategory == 'Tümü' || _activeCategory == 'Notlar') {
          ...
          return matchesSearch && !isArchived && note['category'] == _activeCategory;
        }
      }).toList();
    }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Card(
                          ...
                          child: InkWell(
                            onTap: () =>
                                _showNoteDialog(index: originalIndex),
                            borderRadius: BorderRadius.circular(12),
                            child: Padding(
