...
class _NoteListScreenState extends State<NoteListScreen> {
  ...
  void _showNoteDetails(int noteIndex) {
    ...
    final createdStr = _formatDetailDate(note['createdDate'] as String?);
    final modifiedStr = _formatDetailDate(note['modifiedDate'] as String?);
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      body: AnimatedPadding(
        ...
        child: Padding(
        padding: const EdgeInsets.only(left: 3.0, right: 3.0, bottom: 3.0, top: 8.0),
  ...
  Widget _buildGridView({
    ...
    const double outerPadding = 0.0; // dış konteyner zaten 12px padding veriyor
